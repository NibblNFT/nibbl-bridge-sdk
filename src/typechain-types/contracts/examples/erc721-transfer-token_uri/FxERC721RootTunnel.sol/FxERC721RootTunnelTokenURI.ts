...
export interface FxERC721RootTunnelTokenURIInterface extends utils.Interface {
  functions: {
...
export interface FxERC721RootTunnelTokenURI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FxERC721RootTunnelTokenURIInterface;
