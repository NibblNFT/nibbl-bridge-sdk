...
export interface FxERC721Interface extends utils.Interface {
  functions: {
...
export interface FxERC721 extends BaseContract {
  ...
  functions: {
    ...
    initialize(
      fxManager_: PromiseOrValue<string>,
      connectedToken_: PromiseOrValue<string>,
