...
export interface IFxERC721Interface extends utils.Interface {
  functions: {
...
export interface IFxERC721 extends BaseContract {
  ...
  functions: {
    ...
    initialize(
      _fxManager: PromiseOrValue<string>,
      _connectedToken: PromiseOrValue<string>,
